...
| 36 | The Cloudflare account id and account email were committed in `site/.wrangler/`; untracked and gitignored | `.gitignore` | found while indexing, 6 Sep 2026 | partly done: still present in git history, removal needs a rewrite |
